---
layout: post
tags: rpgs homebrew journal
---

The other week I ran the first session of a post apocalyptic hex crawl TRPG I'm calling, for lack of a better name, [Dominion of the Sword](https://iendjinn-ga.me/systems/dominion-of-the-sword/). I transplanted some of the lore I'd written for a post apocalyptic wargame to come up with the seed for a setting and then fleshed out the local area and set the players loose.

The system name is inspired by this [old English ballad](https://mainlynorfolk.info/martin.carthy/songs/thedominionofthesword.html) which I think gives the sense of a period in which strength and daring can overcome entrenched powers and allow new ones to rise in their place. Exactly the kind of setting where the players can encounter and become techno barbarian warlords. 

The game is set up to encourage dungeon delving, exploration, and the reckless pursuit of **treasure**. The system is loosely based on [Into the Odd](https://freeleaguepublishing.com/games/into-the-odd/), with some other concepts I like from various different games.

You can find character sheets here: [printable](https://iendjinn-ga.me/systems/dominion-of-the-sword/character-sheet) and [online](https://iendjinn-ga.me/systems/dominion-of-the-sword/app/). Don't worry, all data entered into the app is stored purely in local storage and never gets sent anywhere.

## Session 1

In which the party:

- steals an old man's microwave
- confuses microbes with micro USB
- gets trapped in an underground lab

After a brief bit of character generation, our heroes were ready:

- Silus Cogwraith the technomancer, with his loyal thrall Christian
- Brick Meatgrinder, local gang rat and crayon enthusiast
- Dukat Lotus, noble ~~heir~~ brat and their squire Mezoti 
...
- microwave oven (1000xp)
- ammo (500xp)
- solar panels (1000xp x 2)
- adamantine cuirass (2000xp)
- lightning stick (2000xp)
- laser rifle (2000xp)