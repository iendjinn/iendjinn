...
While I'm pretty sad to see a system and setting I worked on (and my chance to run a hex crawl) go to waste the silver lining is that due to getting a random selection of 2-4 players we decided to run some cyberpunk one shots, set in the cy_borg setting. This quickly gained momentum thanks to the episodic nature of the sessions which allowed players to drop in and out easily, without affecting the versimilitude of the world.
...
I've also become active in the cy_borg discord server, which has a ton of great channels for inspiration and game discussion. Though I feel a little bit like an imposter since I'm not running the official cy_borg system - but hey, cyberpunk is definitely not about conforming.

To conclude, if you're finding that life is getting in th way try and episodic campaign/open table. Give up on the idea that you'll always have the same players each week and just enjoy the variety that different numbers of players gives you.