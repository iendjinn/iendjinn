---
layout: post
tags: mothership rpgs review
---

The Haunting of Ypsilon-14 is a tri-fold pamphlet adventure for the [Mothership RPG](https://www.tuesdayknightgames.com/pages/mothership-rpg). Set on a mining station, the players are visiting the station when people start disappearing. In classic mothership style they then have to survive, solve or save in the ensuing chaos.

>Full disclosure I ran this module in my own [sci fi system](https://iendjinn.github.io/sci-fi).

I picked up a [physical copy](https://www.tuesdayknightgames.com/products/the-haunting-of-ypsilon-14) of this module as part of a bulk load of Mothership content, for a very reasonable 4 credits. The pamphlet itself is printed on yellow card and the presentation is excellent, cramming a ton of information into the available space. One minor gripe is the presence of a couple of typos, nothing that caused issues, but really for a module this short I'd expect these to have been picked up in proof reading. 
...
Prior to running the session I'd read the [Alexandrian's post](https://thealexandrian.net/wordpress/51526/roleplaying-games/how-to-prep-the-haunting-of-ypsilon-14) on prepping for it, which has some pretty good advice. Specifically the recommendation to find some character artwork to represent each of the station crew was spot on. With such a large cast for a relatively short adventure it really helped the players to understand who was who.

I ran this session virtually, and when one of the players accessed the terminal in the station I sent them over a link to this [excellent little app](https://redhg.com/ypsilon14/) that simulates the terminal interface. Like the audio recordings this really helped add to the immersion. Many thanks to Red Mercury for building this, and to Quadra for highlighting it on [their blog](https://www.traaa.sh/the-ypsilon-14-terminal).
...
Nobody wake the bugbear have a [play through](https://nwtb.podbean.com/e/system-shock-mothership-the-haunting-of-ypsilon-14-trailer/) and I also watched Mystery Quest's [play through](https://m.youtube.com/watch?v=AXNbfzds0Qo). Seeing how different GMs run a scenario is a great way of improving your own game mastering.
...
After about 30 minutes the players decided to go and bang on the Heracles' airlock to ask Dr Giovanni where the package was. They activated the intercom and a raspy voice responded. I played Giovanni as semi-lucid, obsessing over his discovery and demanding another hour to finish his work. This gave the players a bit of a clue that _something wasn't right_ without giving too many details and helped to build up a bit of tension.
...
- character generation worked great, players randomly generated cohesive characters that they liked within 15 minutes
- cool checks worked well
- the fixed set of difficulties let players feel good at the things they specialised in but kept other tasks tense
- players want to continue this on into a campaign

Bad:

- probably pulled the punches a little with the monster, have to trust the system more
- forgot that the Heracles airlock required manual work to access 